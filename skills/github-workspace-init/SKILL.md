---
name: github-workspace-init
description: Initialize a GitHub workspace configuration in the current repository. Creates .hiivmind/github/ with config files for caching org/project metadata. Use as the first step when setting up GitHub CLI Toolkit for a project.
---
...
**Note:** After initializing, run `github-workspace-analyze` to discover and cache project structure.
...
```yaml
# GitHub CLI Toolkit - Workspace Configuration
# This file is shared across the team and should be committed to git.
# Generated by github-workspace-init on YYYY-MM-DDTHH:MM:SSZ
...
```yaml
# GitHub CLI Toolkit - User Configuration
